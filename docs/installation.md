...
This pipeline itself needs no installation - NextFlow will automatically fetch it from GitHub if `remiolsen/nf-core-radseq` is specified as the pipeline name.
